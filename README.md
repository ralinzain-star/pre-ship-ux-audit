...
docs/                      the architecture diagram, as HTML and PDF
...
The HTML is the source. The script flattens the CSS variables and web fonts svglib cannot
resolve; its docstring lists the three failure modes it works around, each of which comes
out as a silently wrong PDF rather than an error.
